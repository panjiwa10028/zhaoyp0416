...
<div id="m_Campaign" >
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
		<tr id="m_Campaign_h" >
			...
			<td height="30" background="<%=strContextPath%>/images/d_corner_02.gif">
				<table width="100%" border="0" cellspacing="0" cellpadding="3">
					<tr>
						<td class="dropTitle"><%=Function.getMultiLangItemContent("personalInfo.agent.Campaign2",request)%></td>
						<td width="40" valign="bottom" nowrap style="cursor: hand">
							<c:if test="${campaignList2!='[]'}">
								<a onclick="javascript:campaign2More();">
		...
		<tr>
			<td width="8" height="50" background="<%=strContextPath%>/images/d_corner_04.gif"><img src="<%=strContextPath%>/images/d_corner_04.gif" width="8" height="2" alt=""></td>
			<td valign="top" background="<%=strContextPath%>/images/d_corner_05.gif">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="displayTable">
					<c:forEach var="msg" items="${campaignList2}" varStatus="status">
						<tr>
							<td width="15">
								&nbsp;
							</td>
							<td>
								<span class="displayText"><a style="CURSOR:hand" title="<c:out value='${msg.STRNAME}'/>" onclick="showCampaign2(<c:out value='${msg.LID}'/>)"><c:out value="${msg.STRNAME}" />
								</a>
								</span>
							</td>
							<td width="270" nowrap>
