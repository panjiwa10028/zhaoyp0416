...
<!--
	...
	arrMenuItem[0].strLabel			="<%=Function.getMultiLangItemContent("common.addType", request)%>";
	...
	arrMenuItem[1].strLabel			="<%=Function.getMultiLangItemContent("common.modifyType", request)%>";
	...
	arrMenuItem[2].strLabel			="<%=Function.getMultiLangItemContent("common.deleteType", request)%>";
	...
	menu.strIcon	="<%=strContextPath%>/images/triangle1.gif";
	//menu.nLeft	=92;
	menu.nTop		=20;
	menu.nWidth		=80;
	menu.nHeight	=76;
