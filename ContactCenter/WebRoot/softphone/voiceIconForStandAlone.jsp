...
<script language="javascript" type="text/javascript">
	tips_map.put("ivrImage",			"<%=Function.getMultiLangItemContent("softphone.ivr", request)%>");
	tips_map.put("lineOneImage",		"<%=Function.getMultiLangItemContent("softphone.lineone", request)%>");
	tips_map.put("lineTwoImage",		"<%=Function.getMultiLangItemContent("softphone.linetwo", request)%>");
	tips_map.put("lineThreeImage",		"<%=Function.getMultiLangItemContent("softphone.linethr", request)%>");
	tips_map.put("keypadImage",			"<%=Function.getMultiLangItemContent("softphone.keyboard", request)%>");
	tips_map.put("holdImage",			"<%=Function.getMultiLangItemContent("softphone.hold", request)%>");
	tips_map.put("transferImage",		"<%=Function.getMultiLangItemContent("softphone.transfer", request)%>");
	tips_map.put("conferenceImage",		"<%=Function.getMultiLangItemContent("softphone.conference", request)%>");
	tips_map.put("chatImage",			"<%=Function.getMultiLangItemContent("softphone.chat", request)%>");
	tips_map.put("mailinImage",			"<%=Function.getMultiLangItemContent("softphone.email", request)%>");
	tips_map.put("newEmailImage",		"<%=Function.getMultiLangItemContent("softphone.newEmail", request)%>");
	tips_map.put("workbinEmailImage",	"<%=Function.getMultiLangItemContent("softphone.workbin", request)%>");
	tips_map.put("cobrowseImage",		"<%=Function.getMultiLangItemContent("softphone.cobrowse", request)%>");	
	tips_map.put("dialImage_enabled",	"<%=Function.getMultiLangItemContent("softphone.call", request)%>");
	tips_map.put("dialImage_ringing",	"<%=Function.getMultiLangItemContent("softphone.ringing", request)%>");
	//tips_map.put("dialImage_dialing",	"<%=Function.getMultiLangItemContent("softphone.dialing", request)%>");
	tips_map.put("disconImage_hangup",	"<%=Function.getMultiLangItemContent("softphone.hangup", request)%>");
	tips_map.put("disconImage_refuse",	"<%=Function.getMultiLangItemContent("softphone.refuse", request)%>");
	tips_map.put("softkeyA",			"<%=Function.getMultiLangItemContent("softphone.backspace", request)%>");
	tips_map.put("softkeyB",			"<%=Function.getMultiLangItemContent("softphone.clear", request)%>");
	tips_map.put("softkeyC",			"<%=Function.getMultiLangItemContent("softphone.redial", request)%>");
	tips_map.put("softkeyD",			"<%=Function.getMultiLangItemContent("softphone.call", request)%>");
    ...
    <tr>
      <td width="52" align="right">
      	...
      	<div id="keypadImage" class="keypadImage_disabled" 
					...
					onClick="showHideDiv('softKeyBoardDiv');showHideDiv('softPhonePadFrame');" disabled></div>
      </td>
      <td width="50"><table width="100%" border="0" cellpadding="1" cellspacing="0">
        <tr>
          <td>
      ...
      <td width="160">
		  <table width="157" height="47" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td width="5" rowspan="3"><img src="<%=contextPath%>/images/agent_image/Top_toolbarM_left.gif" width="5" height="47"></td>
			  <td height="6" colspan="2" background="<%=contextPath%>/images/agent_image/Top_toolbarM_topbg.gif"></td>
			  <td width="5" rowspan="3"><img src="<%=contextPath%>/images/agent_image/Top_toolbarM_right.gif" width="5" height="47"></td>
			</tr>
			<tr>
			  <td height="23" colspan="2" background="<%=contextPath%>/images/agent_image/box02_out_bg.gif">
			...
			<tr>
			  <td height="16" valign="top" background="<%=contextPath%>/images/agent_image/Top_toolbarM_bottombg.gif">
                <span id="statWord"><img id="lineStateImage" src="<%=contextPath%>/images/cti_image/ban_top_phone_leisure.gif" width="10" height="8" border="0" align="absmiddle"> <span class="statWord" id="lineStatusDiv"></span></span></td>
			  <td align="right" background="<%=contextPath%>/images/agent_image/Top_toolbarM_bottombg.gif" class="nobreak">
...
<iframe id="softPhonePadFrame" style="display:none"></iframe>
<div id="softKeyBoardDiv" style="display:none">
<table border="0" width="464" height="203" cellpadding="0" cellspacing="0">
	<tr>
	  <td width="32" valign="top" nowrap background="<%=contextPath%>/images/keypad_image/SZJP_leftbg.gif"><table width="32" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top"><img id="softKeyImg" src="<%=contextPath%>/images/keypad_image/SZJP_tab1_current.gif" width="32" height="43" class="pointer" alt="<%=Function.getMultiLangItemContent("softphone.keyboard", request)%>" onClick="changeSoftKeyBoard('softKey')"></td>
        </tr>
        <tr>
          <td valign="top"><img id="hisAddImg" src="<%=contextPath%>/images/keypad_image/SZJP_tab2_normal.gif" width="32" height="43" border="0" class="pointer" alt="<%=Function.getMultiLangItemContent("softphone.callhistory", request)%>" onClick="changeSoftKeyBoard('callHis')"></td>
        </tr>
        <tr>
          <td valign="top"><img id="AddImg" src="<%=contextPath%>/images/keypad_image/SZJP_tab3_normal.gif" width="32" height="43" border="0" class="pointer" alt="<%=Function.getMultiLangItemContent("softphone.address", request)%>" onClick="changeSoftKeyBoard('address')"></td>
        </tr>
        <tr>
          <td valign="top"><img src="<%=contextPath%>/images/keypad_image/SZJP_tab_bottom.gif" width="32" height="3" class="pointer"></td>
        </tr>
      </table></td>
      <td width="416" valign="top" background="<%=contextPath%>/images/keypad_image/SZJP_middlebg.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="2" colspan="2" background="<%=contextPath%>/images/keypad_image/SZJP_topbg.gif"><img src="<%=contextPath%>/images/keypad_image/SZJP_top_middle.gif" width="262" height="2"></td>
        </tr>
      </table>
        <div id="softKeyBoard">
		...
		<div id="callHistoryBoard" style="padding:5px 0px 0px 7px; display:none">
	          ...
	          <td><table width="201" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <table width="201" border="0" cellpadding="0" cellspacing="0">
	              <tr>
	                ...
	                <td height="170" width="198" valign="top" background="<%=contextPath%>/images/keypad_image/call_his_left_05.gif">
	          ...
	          <td><table width="201" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <table width="201" border="0" cellpadding="0" cellspacing="0">
	              <tr>
	                ...
	                <td height="170" width="198" valign="top" background="<%=contextPath%>/images/keypad_image/call_his_right_05.gif">
	  	...
	  	<div id="addressBoard" style="display:none">
	  		<iframe id="addressFRM" src="<%=contextPath%>/softphone/common/address.htm" frameborder="0" hspace="0" marginheight="0" marginwidth="0" width="415" height="195" allowtransparency="yes"></iframe>
		</div>
		
		</td>
      <td width="16" align="right" valign="top" nowrap background="<%=contextPath%>/images/keypad_image/SZJP_rightbg.gif"><img src="<%=contextPath%>/images/keypad_image/SZJP_top_right.gif" width="16" height="8"></td>
	</tr>
	<tr>
	  <td height="2" colspan="3" valign="top" nowrap background="<%=contextPath%>/images/keypad_image/SZJP_bottombg.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="90%" align="left" valign="top"><img src="<%=contextPath%>/images/keypad_image/SZJP_bottom_left.gif" width="262" height="2"></td>
          <td width="10%" align="right" valign="top"><img src="<%=contextPath%>/images/keypad_image/SZJP_bottom_right.gif" width="20" height="2"></td>
        </tr>
      </table></td>
  </tr>
</table>
