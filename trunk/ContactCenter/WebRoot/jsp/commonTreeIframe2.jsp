...
<body onLoad="loadInfo()">
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	  <tr>
	    <td height="50">
	      <strong style="font-size:12px; padding-left:10px"><%=Function.getMultiLangItemContent("Common.select",request)%></strong>
	    </td>
	  </tr>  
	  <tr>
	    <td height="415">
			<div id="treeDiv" style="width:303px; height:415px; overflow:auto;margin:0px 20px; margin-bottom:8px; border:1px solid #cccccc; background-color:#FFFFFF;"></div>
		</td>
	  </tr>
	  <tr>			    
	    <td align="center" background="<%=strContextPath%>/images/mac_bg1.gif" style="border-top:1px solid #cccccc">
