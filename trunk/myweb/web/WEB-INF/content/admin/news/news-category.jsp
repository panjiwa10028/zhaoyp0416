...
<html xmlns="http://www.w3.org/1999/xhtml">
	<HEAD>
		...
		function update() {		
			...
			var url = "news-category!input.action?id="+ids+"&page.pageRequest=${page.pageRequest}";
			top.mainWorkArea.location = url;
		}
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="tdCenterH40">
                                                  类别名称：<input type="text" name="filter_LIKE_name" value="${param['filter_LIKE_name']}" size="20"/>
                                                </td>
					...
					<TD id="tdQueryResult1" class="tdCommonTop">
						...
						<table class="dgMain" cellspacing="0" cellpadding="3"
							...
							<tr class="dgHeader" align="Center">
								...
								<td class="dgHeader">
									<a href="news-category.action?page.orderBy=name&page.order=
			<s:if test="page.orderBy=='name'">${page.inverseOrder}</s:if><s:else>desc</s:else>"><b>名称</b>
									</a>
								</td>
							</tr>
