...
/*********************************
*根据triggerFunc的参数获取 功能名称等信息
*参数：args:triggerFunc的 arguments
*返回值：如果从配置文件中找到，返回对应的json对象，否则返回null
**********************************/
...
window.onload = function()
{
	...
	var header = menu.addHeader("常用功能","");
	...
	var header = menu.addHeader("历史操作","");
	HistoryOpMenuMgr.init("testMenu",header);
	HistoryOpMenuMgr.clear();
	var header = menu.addHeader("我的收藏夹","");
