...
@Results( { @Result(name = CRUDActionSupport.RELOAD, value = "/menu", type = ServletActionRedirectResult.class) 
	,@Result(name = CRUDActionSupport.SUCCESS, value = "/menuManager/menu", type = ServletActionRedirectResult.class)})
public class MenuAction extends CRUDActionSupport<TMenus> {
	...
	private Page<TMenus> page = new Page<TMenus>(10, true);//每页5项，自动查询计算总页数.
