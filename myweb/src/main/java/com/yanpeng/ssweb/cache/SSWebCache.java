package com.yanpeng.ssweb.cache;
...
public class SSWebCache {
	...
	private static final Logger logger = LoggerFactory.getLogger(SSWebCache.class);
	 ...
	 */
	public static SSWebCache getInstance() {
		if (instance == null) {
			synchronized (lockObject) {
				logger.info("创建新的缓存类实例");
				instance = new SSWebCache();
			}
		}
		return instance;
	}
